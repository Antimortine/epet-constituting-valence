...
# --- Имена файлов ---
OUTPUT_PDF = output/EPET_Constituting_Valence_1.0.pdf
ANONYMOUS_PDF_OUTPUT = output/EPET_Constituting_Valence_Anonymous_1.0.pdf
SM_PDF_OUTPUT = output/EPET_Constituting_Valence_Supplementary_Materials_1.0.pdf
